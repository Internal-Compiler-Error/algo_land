...
TEST_CASE("map can construct as <int, int> pair", "[construct]") { algo::rb_map<int, int> m; }

TEST_CASE("map can construct as <std::string, int> pair", "[construct]") { algo::rb_map<std::string, int> map; }

TEST_CASE("map cannot construct as <std::vector<int>, int> pair", "[construct]") { algo::rb_map<std::vector<int>, int> map; }

TEST_CASE("map::at returns the node", "[access]") {
    algo::rb_map<int, int> map;
